...
public class JavaFXPaint extends Application {
    ...
    public void start(Stage primaryStage) {
        ...
        Canvas sandboxCanvas = new Canvas(CANVAS_WIDTH, CANVAS_HEIGHT);
        GraphicsContext draw = myCanvas.getGraphicsContext2D();
        GraphicsContext sandboxDraw = sandboxCanvas.getGraphicsContext2D();
        ...
        clearButton.setOnAction(e -> {
            ...
            sandboxDraw.clearRect(0, 0, CANVAS_WIDTH, CANVAS_HEIGHT);
        });
